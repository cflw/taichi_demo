...
v场景.add(C球体(t向量3(c墙壁半径 + 1.5, 0, -1), c墙壁半径, t向量3(.8, .3, .3), E材质.e漫反射))	#镜头右
v场景.add(C球体(t向量3(-c墙壁半径 - 1.5, 0, -1), c墙壁半径, t向量3(.3, .3, .8), E材质.e漫反射))	#镜头左
...
v场景.add(C球体(t向量3(0.6, -0.3, -2.0), 0.2, t向量3(0.8, 0.6, 0.2), E材质.e模糊反射))
